...
const SYSTEM_PROMPT = `You are Property AI, the digital concierge for Attri Property Consultancy — a trusted real estate agency in the Mohali tri-city (Mohali, Chandigarh, Zirakpur, Kharar, New Chandigarh).

Firm facts:
- Firm: Attri Property Consultancy
- Office: House No. 2918, Phase 7, Sector 79, Sahibzada Ajit Singh Nagar, Punjab 140308
...
function PropertyAI({ onSchedule }) {
  ...
  const send = async (text) => {
    ...
    try {
      ...
      setMessages((m) => [...m, { role: "assistant", content: "I can't reach my brain right now. Please call the desk on +91 98765 00003 — they'll be happy to help." }]);
    } finally {
      setSending(false);
    }
  };
